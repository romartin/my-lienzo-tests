...
public class AutoMagnetsConnectorsTests extends FlowPanel implements MyLienzoTest, HasMediators, HasButtons {
    ...
    public void test(Layer layer) {
        ...
        // Blue rectangle.
        WiresShape blueRectShape = new WiresShape(new MultiPath().rect(100, 100, 100, 100).setStrokeColor( ColorName.BLUE ));
        ...
        // Green rectangle.
        WiresShape greenRectShape = new WiresShape(new MultiPath().rect(300, 300, 100, 100).setFillColor( ColorName.GREEN ));
        ...
        // Black rectangle.
        WiresShape blackRectShape = new WiresShape(new MultiPath().rect(500, 100, 100, 100).setFillColor( ColorName.BLACK));
        ...
        c1 = connect(layer, blueRectShape.getMagnets(), 3, greenRectShape.getMagnets(), 7, wires_manager);
