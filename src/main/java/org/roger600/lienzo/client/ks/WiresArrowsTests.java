...
public class WiresArrowsTests extends FlowPanel implements MyLienzoTest {
    ...
    public void test(final Layer layer) {
        ...
        WiresShape wiresShape0 = new WiresShape(new MultiPath().rect(0,
                                                                     0,
                                                                     w,
                                                                     h).setStrokeColor("#CC0000")).setX(400).setY(400).setDraggable(true);
        ...
        WiresShape wiresShape1 = new WiresShape(new MultiPath().rect(0,
                                                                     0,
                                                                     w,
                                                                     h).setStrokeColor("#00CC00")).setX(50).setY(50).setDraggable(true);
        ...
        WiresShape wiresShape2 = new WiresShape(new MultiPath().rect(0,
                                                                     0,
                                                                     300,
                                                                     200).setStrokeColor("#0000CC")).setX(50).setY(100).setDraggable(true);
